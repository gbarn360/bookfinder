    ...
    return(
        <div className='w-full h-screen'>
            <div className='w-2/3 mt-40  m-auto flex flex-col items-center gap-y-6 '>
                ...
                <h2 className='w-full md:w-1/2 text-lg  text-center'>Search through thousands of books to find exactly what you're looking for...</h2>
            ...
            <div className='w-2/3 2xl:w-1/2 m-auto my-40 '>
                ...
                <div className='w-5/6 h-40 border-b-4 border-l-4 my-4 m-auto border-blue-50'></div>
                <h3 className='text-base  text-right'>Reading fiction has been shown to  <span className='text-blue-300 font-bold'>improve empathy.</span></h3>
                <div className='w-5/6 h-40 border-r-4  border-b-4 my-4 m-auto border-blue-50'></div>
                <h3 className='text-base  w-fit'>Regular reading has been shown to <span className='text-blue-300 font-bold'>increase focus and concentration</span></h3>
            </div>
            <Footer />
        </div>
    )
